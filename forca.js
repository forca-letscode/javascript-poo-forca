...
// Fazer todas as validações necessárias (prever erros do usuário, como digitar um número ao invés de uma letra, dentre outros); 22h04

// EXTRA: CRIAR A INTERFACE GRÁFICA


class Forca {
    constructor(nome, email, jogar = true, palavras = Array(3), vitorias, derrotas) {
        this.nome = nome;
        this.email = email;
        this.jogar = jogar;
